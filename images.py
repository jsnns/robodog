...
def capture_canvas_images(url, interval=0.5):
    ...
    # Click the button
    try:
        button = driver.find_element(By.CSS_SELECTOR, 'div.innerWrap div.aiSwitchButton.left')
        button.click()
    ...
    while True:
        try:
            ...
            for container in canvas_containers:
                canvases = container.find_elements(By.CSS_SELECTOR, 'canvas[data-v-575a3a00]')
